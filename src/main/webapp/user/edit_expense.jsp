						...
						<form action="../updateExpense" method="post">
							...
							<div class="mb-3">
								<label>Title</label> <input type="text" name="title"
									class="form_control" value="<%=ex.getTitle()%>">
							</div>

							<div class="mb-3">
								<label>Date</label> <input type="date" name="date"
									class="form_control" value="<%=ex.getDate()%>">
							</div>
							...
							<div class="mb-3">
								<label>Time</label> <input type="time" name="time"
									class="form_control" value="<%=ex.getTime()%>">
							</div>

							<div class="mb-3">
								<label>Description</label> <input type="text" name="description"
									class="form_control" value=<%=ex.getDescription()%>>
							</div>

							<div class="mb-3">
								<label>Price</label> <input type="text" name="price"
									class="form_control" value=<%=ex.getPrice()%>>
							</div>
